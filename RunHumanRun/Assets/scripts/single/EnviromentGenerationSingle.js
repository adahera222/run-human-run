...
// generator sciezki
private var pathGenerator: PathGeneratorSingle;
...
function Awake () {
	...
	pathGenerator = gameObject.GetComponent(PathGeneratorSingle);
...
function SendNextPoints () {
	...
	GameObject.FindGameObjectWithTag("Zombie").SendMessage("UpdateTargets", points);
}
