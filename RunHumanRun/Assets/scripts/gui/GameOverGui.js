...
function OnGUI()
{
	...
	GUI.Label(Rect((Screen.width / (2 * gameOverScale)) - 150, (Screen.height / (2 * gameOverScale)) - 40, 300, 100), 
		"Game Over. You have collected " + ThirdPersonStatus.GetPoints() + " points.", 
		gameOverText);
}